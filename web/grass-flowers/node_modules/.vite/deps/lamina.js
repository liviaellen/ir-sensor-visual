import {
  ...
  q,
  ve
} from "./chunk-I2O5UQ6O.js";
import "./chunk-EL2RN6TU.js";
import {
  useDrag
} from "./chunk-3WQTQBUM.js";
import {
  require_client
  ...
  "node_modules/assign-symbols/index.js"(exports, module) {
    ...
    module.exports = function(receiver, objects) {
      ...
      while (++i4 < len) {
        ...
        for (var j4 = 0; j4 < names.length; j4++) {
          var key = names[j4];
          ...
          if (str.indexOf(e4, i4 + 1) !== -1) {
            while (stack.length && i4 < len) {
              ...
              if (quotes.indexOf(s5) !== -1) {
                i4 = getClosingQuote(str, s5, i4 + 1);
                continue;
              }
              e4 = expected();
...
var S2 = (e4) => e4 ? e4 + "-" : "";
var k = (e4, t4, r4) => e4.replace(/([+-])?((?:\d+(?:\.\d*)?|\.\d+)(?:[Ee][+-]?\d+)?)?(\$|--)([$\w-]+)/g, ((e5, n4, i4, o4, l4) => "$" == o4 == !!i4 ? e5 : (n4 || "--" == o4 ? "calc(" : "") + "var(--" + ("$" === o4 ? S2(t4) + (l4.includes("$") ? "" : S2(r4)) + l4.replace(/\$/g, "-") : l4) + ")" + (n4 || "--" == o4 ? "*" + (n4 || "") + (i4 || "1") + ")" : "")));
var y = /\s*,\s*(?![^()]*\))/;
var B2 = Object.prototype.toString;
var $2 = (e4, t4, r4, n4, i4) => {
  let o4, l4, s5;
  const a4 = (e5, t5, r5) => {
    let c4, g4;
    const p4 = (e6) => {
      for (c4 in e6) {
        ...
        for (g4 of z2) {
          const e7 = /[A-Z]/.test($5 = c4) ? $5 : $5.replace(/-[^]/g, ((e8) => e8[1].toUpperCase())), z3 = "object" == typeof g4 && g4 && g4.toString === B2 && (!n4.utils[e7] || !t5.length);
          if (e7 in n4.utils && !z3) {
            ...
            const t6 = u[e7];
            if (t6 !== s5) {
              s5 = t6, p4(t6(g4)), s5 = null;
              continue;
            }
          }
          if (R3 && (b4 = c4.slice(1) in n4.media ? "@media " + n4.media[c4.slice(1)] : c4, c4 = b4.replace(/\(\s*([\w-]+)\s*(=|<|<=|>|>=)\s*([\w-]+)\s*(?:(<|<=|>|>=)\s*([\w-]+)\s*)?\)/g, ((e8, t6, r6, n5, i5, o5) => {
            const l5 = h.test(t6), s6 = 0.0625 * (l5 ? -1 : 1), [a5, c5] = l5 ? [n5, t6] : [t6, n5];
            return "(" + ("=" === r6[0] ? "" : ">" === r6[0] === l5 ? "max-" : "min-") + a5 + ":" + ("=" !== r6[0] && 1 === r6.length ? c5.replace(h, ((e9, t7, n6) => Number(t7) + s6 * (">" === r6 ? 1 : -1) + n6)) : c5) + (i5 ? ") and (" + (">" === i5[0] ? "min-" : "max-") + a5 + ":" + (1 === i5.length ? o5.replace(h, ((e9, t7, r7) => Number(t7) + s6 * (">" === i5 ? -1 : 1) + r7)) : o5) : "") + ")";
          }))), z3) {
            const e8 = R3 ? r5.concat(c4) : [...r5], n5 = R3 ? [...t5] : f(t5, c4.split(y));
            void 0 !== o4 && i4(x(...o4)), o4 = void 0, a4(g4, n5, e8);
          } else void 0 === o4 && (o4 = [[], t5, r5]), c4 = R3 || 36 !== c4.charCodeAt(0) ? c4 : `--${S2(n4.prefix)}${c4.slice(1).replace(/\$/g, "-")}`, g4 = z3 ? g4 : "number" == typeof g4 ? g4 && e7 in I ? String(g4) + "px" : String(g4) : k(m(e7, null == g4 ? "" : g4), n4.prefix, n4.themeMap[e7]), o4[0].push(`${R3 ? `${c4} ` : `${d(c4)}:`}${g4}`);
        }
      }
      var b4, $5;
    };
...
var E = (e4) => {
  ...
  const r4 = () => {
    ...
    for (const e5 of i4) if (j2(e5)) {
      for (let i5 = 0, o5 = e5.cssRules; o5[i5]; ++i5) {
        const l5 = Object(o5[i5]);
        if (1 !== l5.type) continue;
        const s5 = Object(o5[i5 + 1]);
        if (4 !== s5.type) continue;
        ++i5;
        const { cssText: a4 } = l5;
        if (!a4.startsWith("--sxs")) continue;
        const c4 = a4.slice(14, -3).trim().split(/\s+/), d4 = W[c4[0]];
        d4 && (t4 || (t4 = { sheet: e5, reset: n4, rules: {}, toString: r4 }), t4.rules[d4] = { group: s5, index: i5, cache: new Set(c4) });
      }
      if (t4) break;
    }
    if (!t4) {
...
var M2 = (e4, t4) => w(e4, (() => (...r4) => {
  ...
  } else t5.constructor !== Object || t5.$$typeof ? null == n4.type && (n4.type = t5) : n4.composers.add(C2(t5, e4));
  return null == n4.type && (n4.type = "span"), n4.composers.size || n4.composers.add(["PJLV", {}, [], [], {}, []]), P(e4, n4, t4);
}));
var C2 = ({ variants: e4, compoundVariants: t4, defaultVariants: r4, ...n4 }, i4) => {
  const o4 = `${S2(i4.prefix)}c-${z(n4)}`, l4 = [], s5 = [], d4 = /* @__PURE__ */ Object.create(null), g4 = [];
  for (const e5 in r4) d4[e5] = String(r4[e5]);
  if ("object" == typeof e4 && e4) for (const t5 in e4) {
    p4 = d4, u5 = t5, c.call(p4, u5) || (d4[t5] = "undefined");
    const r5 = e4[t5];
    for (const e5 in r5) {
...
var P = (e4, t4, r4) => {
  const [n4, i4, o4, a4] = L(t4.composers), c4 = "function" == typeof t4.type || t4.type.$$typeof ? ((e5) => {
    ...
    const { css: s5, ...p5 } = l4, u5 = {};
    for (const e5 in o4) if (delete p5[e5], e5 in l4) {
      let t5 = l4[e5];
      "object" == typeof t5 && t5 ? u5[e5] = { "@initial": o4[e5], ...t5 } : (t5 = String(t5), u5[e5] = "undefined" !== t5 || a4.has(e5) ? t5 : o4[e5]);
    } else u5[e5] = o4[e5];
    const h4 = /* @__PURE__ */ new Set([...i4]);
    for (const [n5, i5, o5, l5] of t4.composers) {
      r4.rules.styled.cache.has(n5) || (r4.rules.styled.cache.add(n5), $2(i5, [`.${n5}`], [], e4, ((e5) => {
        d4.styled.apply(e5);
      })));
      const t5 = O2(o5, u5, e4.media), s6 = O2(l5, u5, e4.media, true);
      for (const i6 of t5) if (void 0 !== i6) for (const [t6, o6, l6] of i6) {
        const i7 = `${n5}-${z(o6)}-${t6}`;
        h4.add(i7);
        const s7 = (l6 ? r4.rules.resonevar : r4.rules.onevar).cache, a5 = l6 ? d4.resonevar : d4.onevar;
        s7.has(i7) || (s7.add(i7), $2(o6, [`.${i7}`], [], e4, ((e5) => {
          a5.apply(e5);
        })));
      }
      for (const t6 of s6) if (void 0 !== t6) for (const [i6, o6] of t6) {
        const t7 = `${n5}-${z(o6)}-${i6}`;
        h4.add(t7), r4.rules.allvar.cache.has(t7) || (r4.rules.allvar.cache.add(t7), $2(o6, [`.${t7}`], [], e4, ((e5) => {
          d4.allvar.apply(e5);
        })));
      }
    }
    if ("object" == typeof s5 && s5) {
      const t5 = `${n4}-i${z(s5)}-css`;
      h4.add(t5), r4.rules.inline.cache.has(t5) || (r4.rules.inline.cache.add(t5), $2(s5, [`.${t5}`], [], e4, ((e5) => {
        d4.inline.apply(e5);
      })));
    }
...
var L = (e4) => {
  let t4 = "";
  const r4 = [], n4 = {}, i4 = [];
  for (const [o4, , , , l4, s5] of e4) {
    "" === t4 && (t4 = o4), r4.push(o4), i4.push(...s5);
    for (const e5 in l4) {
      const t5 = l4[e5];
      (void 0 === n4[e5] || "undefined" !== t5 || s5.includes(t5)) && (n4[e5] = t5);
    }
  }
...
var F2 = o();
var J = (e4, t4) => F2(e4, (() => (r4, n4) => {
  n4 = "object" == typeof r4 && r4 || Object(n4);
  const i4 = `.${r4 = (r4 = "string" == typeof r4 ? r4 : "") || `${S2(e4.prefix)}t-${z(n4)}`}`, o4 = {}, l4 = [];
  for (const t5 in n4) {
    o4[t5] = {};
    for (const r5 in n4[t5]) {
      const i5 = `--${S2(e4.prefix)}${t5}-${r5}`, s6 = k(String(n4[t5][r5]), e4.prefix, t5);
      o4[t5][r5] = new G(r5, s6, t5, e4.prefix), l4.push(`${i5}:${s6}`);
    }
  }
  const s5 = () => {
...
var q2 = (e4) => {
  const t4 = ((e5) => {
    ...
    const r4 = U(e5, ((e6) => {
      t5 = true;
      const r5 = "prefix" in (e6 = "object" == typeof e6 && e6 || {}) ? String(e6.prefix) : "", i4 = "object" == typeof e6.media && e6.media || {}, o4 = "object" == typeof e6.root ? e6.root || null : globalThis.document || null, l4 = "object" == typeof e6.theme && e6.theme || {}, s5 = { prefix: r5, media: i4, theme: l4, themeMap: "object" == typeof e6.themeMap && e6.themeMap || { ...n }, utils: "object" == typeof e6.utils && e6.utils || {} }, a4 = E(o4), c4 = { css: M2(s5, a4), globalCss: D(s5, a4), keyframes: V(s5, a4), createTheme: J(s5, a4), reset() {
        a4.reset(), c4.theme.toString();
      }, theme: {}, sheet: a4, config: s5, prefix: r5, getCssText: a4.toString, toString: a4.toString };
...
function getHullPresorted(points) {
  ...
  for (let i4 = 0; i4 < points.length; i4++) {
    ...
    while (upperHull.length >= 2) {
      ...
      if ((q4.x - r4.x) * (p4.y - r4.y) >= (q4.y - r4.y) * (p4.x - r4.x)) upperHull.pop();
      else break;
    }
    upperHull.push(p4);
  }
  ...
  for (let i4 = points.length - 1; i4 >= 0; i4--) {
    ...
    while (lowerHull.length >= 2) {
      ...
      if ((q4.x - r4.x) * (p4.y - r4.y) >= (q4.y - r4.y) * (p4.x - r4.x)) lowerHull.pop();
      else break;
    }
    lowerHull.push(p4);
  }
...
var h2 = function(r4) {
  var t4 = r4.r, n4 = r4.g, e4 = r4.b, u5 = r4.a, a4 = Math.max(t4, n4, e4), o4 = a4 - Math.min(t4, n4, e4), i4 = o4 ? a4 === t4 ? (n4 - e4) / o4 : a4 === n4 ? 2 + (e4 - t4) / o4 : 4 + (t4 - n4) / o4 : 0;
  return { h: 60 * (i4 < 0 ? i4 + 6 : i4), s: a4 ? o4 / a4 * 100 : 0, v: a4 / 255 * 100, a: u5 };
};
var b2 = function(r4) {
  var t4 = r4.h, n4 = r4.s, e4 = r4.v, u5 = r4.a;
  t4 = t4 / 360 * 6, n4 /= 100, e4 /= 100;
  var a4 = Math.floor(t4), o4 = e4 * (1 - n4), i4 = e4 * (1 - (t4 - a4) * n4), s5 = e4 * (1 - (1 - t4 + a4) * n4), h4 = a4 % 6;
  return { r: 255 * [e4, i4, o4, o4, s5, e4][h4], g: 255 * [s5, e4, e4, i4, o4, o4][h4], b: 255 * [o4, o4, s5, e4, e4, i4][h4], a: u5 };
};
var g2 = function(r4) {
...
var c2 = function(r4) {
  return { h: (t4 = h2(r4)).h, s: (u5 = (200 - (n4 = t4.s)) * (e4 = t4.v) / 100) > 0 && u5 < 200 ? n4 * e4 / 100 / (u5 <= 100 ? u5 : 200 - u5) * 100 : 0, l: u5 / 2, a: t4.a };
  var t4, n4, e4, u5;
};
...
var y2 = { string: [[function(r4) {
  ...
  if (!n4) return null;
  var e4, u5, a4 = g2({ h: (e4 = n4[1], u5 = n4[2], void 0 === u5 && (u5 = "deg"), Number(e4) * (r2[u5] || 1)), s: Number(n4[3]), l: Number(n4[4]), a: void 0 === n4[5] ? 1 : Number(n4[5]) / (n4[6] ? 100 : 1) });
  return f2(a4);
}, "hsl"]], object: [[function(r4) {
  var n4 = r4.r, e4 = r4.g, u5 = r4.b, o4 = r4.a, i4 = void 0 === o4 ? 1 : o4;
  return t2(n4) && t2(e4) && t2(u5) ? a2({ r: Number(n4), g: Number(e4), b: Number(u5), a: Number(i4) }) : null;
}, "rgb"], [function(r4) {
  var n4 = r4.h, e4 = r4.s, u5 = r4.l, a4 = r4.a, o4 = void 0 === a4 ? 1 : a4;
  if (!t2(n4) || !t2(e4) || !t2(u5)) return null;
  var i4 = g2({ h: Number(n4), s: Number(e4), l: Number(u5), a: Number(o4) });
  return f2(i4);
}, "hsl"], [function(r4) {
  var n4 = r4.h, a4 = r4.s, o4 = r4.v, i4 = r4.a, s5 = void 0 === i4 ? 1 : i4;
  if (!t2(n4) || !t2(a4) || !t2(o4)) return null;
  var h4 = (function(r5) {
    return { h: u2(r5.h), s: e2(r5.s, 0, 100), v: e2(r5.v, 0, 100), a: e2(r5.a) };
  })({ h: Number(n4), s: Number(a4), v: Number(o4), a: Number(s5) });
  return b2(h4);
}, "hsv"]] };
...
var x2 = function(r4) {
  return "string" == typeof r4 ? N3(r4.trim(), y2.string) : "object" == typeof r4 && null !== r4 ? N3(r4, y2.object) : [null, void 0];
};
var I2 = function(r4) {
  return x2(r4)[1];
};
...
var j3 = (function() {
  ...
  return r4.prototype.isValid = function() {
    ...
    return r5 = o2(this.rgba), t4 = r5.r, e4 = r5.g, u5 = r5.b, i4 = (a4 = r5.a) < 1 ? s2(n2(255 * a4)) : "", "#" + s2(t4) + s2(e4) + s2(u5) + i4;
    var r5, t4, e4, u5, a4, i4;
  }, r4.prototype.toRgb = function() {
    return o2(this.rgba);
  }, r4.prototype.toRgbString = function() {
    return r5 = o2(this.rgba), t4 = r5.r, n4 = r5.g, e4 = r5.b, (u5 = r5.a) < 1 ? "rgba(" + t4 + ", " + n4 + ", " + e4 + ", " + u5 + ")" : "rgb(" + t4 + ", " + n4 + ", " + e4 + ")";
    var r5, t4, n4, e4, u5;
  }, r4.prototype.toHsl = function() {
    return d2(c2(this.rgba));
  }, r4.prototype.toHslString = function() {
    return r5 = d2(c2(this.rgba)), t4 = r5.h, n4 = r5.s, e4 = r5.l, (u5 = r5.a) < 1 ? "hsla(" + t4 + ", " + n4 + "%, " + e4 + "%, " + u5 + ")" : "hsl(" + t4 + ", " + n4 + "%, " + e4 + "%)";
    var r5, t4, n4, e4, u5;
    ...
    return void 0 === r5 && (r5 = 0.1), w2(M3(this.rgba, r5));
    ...
    return void 0 === r5 && (r5 = 0.1), w2($3(this.rgba, r5));
...
var w2 = function(r4) {
  return r4 instanceof j3 ? r4 : new j3(r4);
};
var S3 = [];
var k2 = function(r4) {
  r4.forEach(function(r5) {
    S3.indexOf(r5) < 0 && (r5(j3, y2), S3.push(r5));
  });
};
...
function names_default(e4, f4) {
  ...
  e4.prototype.toName = function(f5) {
    ...
    if (null == f5 ? void 0 : f5.closest) {
      ...
      for (var g4 in a4) {
        var u5 = (d5 = o4, i4 = l4[g4], Math.pow(d5.r - i4.r, 2) + Math.pow(d5.g - i4.g, 2) + Math.pow(d5.b - i4.b, 2));
        u5 < t4 && (t4 = u5, b4 = g4);
      }
      return b4;
    }
...
var m3 = import_react6.default.memo(function(o4) {
  var a4 = o4.onMove, l4 = o4.onKey, s5 = c3(o4, ["onMove", "onKey"]), m5 = (0, import_react6.useRef)(null), g4 = i3(a4), p4 = i3(l4), b4 = (0, import_react6.useRef)(null), _2 = (0, import_react6.useRef)(false), x3 = (0, import_react6.useMemo)(function() {
    var e4 = function(e5) {
      h3(e5), (f3(e5) ? e5.touches.length > 0 : e5.buttons > 0) && m5.current ? g4(d3(m5.current, e5, b4.current)) : t4(false);
    }, r4 = function() {
      return t4(false);
    };
    function t4(t5) {
      var n4 = _2.current, o5 = v3(m5.current), a5 = t5 ? o5.addEventListener : o5.removeEventListener;
      a5(n4 ? "touchmove" : "mousemove", e4), a5(n4 ? "touchend" : "mouseup", r4);
    }
    return [function(e5) {
      var r5 = e5.nativeEvent, n4 = m5.current;
  ...
  }, [p4, g4]), C3 = x3[0], E3 = x3[1], H3 = x3[2];
  return (0, import_react6.useEffect)(function() {
    return H3;
  }, [H3]), import_react6.default.createElement("div", u3({}, s5, { onTouchStart: C3, onMouseDown: C3, className: "react-colorful__interactive", ref: m5, onKeyDown: E3, tabIndex: 0, role: "slider" }));
});
var g3 = function(e4) {
...
var I3 = function(e4) {
  ...
  var a4 = Math.floor(r4), l4 = n4 * (1 - t4), u5 = n4 * (1 - (r4 - a4) * t4), c4 = n4 * (1 - (1 - r4 + a4) * t4), i4 = a4 % 6;
  return { r: b3(255 * [n4, u5, l4, l4, c4, n4][i4]), g: b3(255 * [c4, n4, n4, u5, l4, l4][i4]), b: b3(255 * [l4, l4, c4, n4, n4, u5][i4]), a: b3(o4, 2) };
};
var L2 = function(e4) {
  var r4 = e4.r, t4 = e4.g, n4 = e4.b, o4 = e4.a, a4 = Math.max(r4, t4, n4), l4 = a4 - Math.min(r4, t4, n4), u5 = l4 ? a4 === r4 ? (t4 - n4) / l4 : a4 === t4 ? 2 + (n4 - r4) / l4 : 4 + (r4 - t4) / l4 : 0;
  return { h: b3(60 * (u5 < 0 ? u5 + 6 : u5)), s: b3(a4 ? l4 / a4 * 100 : 0), v: b3(a4 / 255 * 100), a: o4 };
};
var S4 = import_react6.default.memo(function(r4) {
  ...
  }, "aria-label": "Hue", "aria-valuenow": b3(t4), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react6.default.createElement(p3, { className: "react-colorful__hue-pointer", left: t4 / 360, color: q3({ h: t4, s: 100, v: 100, a: 1 }) })));
});
var T2 = import_react6.default.memo(function(r4) {
  var t4 = r4.hsva, n4 = r4.onChange, o4 = { backgroundColor: q3({ h: t4.h, s: 100, v: 100, a: 1 }) };
  ...
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b3(t4.s) + "%, Brightness " + b3(t4.v) + "%" }, import_react6.default.createElement(p3, { className: "react-colorful__saturation-pointer", top: 1 - t4.v / 100, left: t4.s / 100, color: q3(t4) })));
});
var F3 = function(e4, r4) {
  if (e4 === r4) return true;
  for (var t4 in e4) if (e4[t4] !== r4[t4]) return false;
  return true;
};
function Y2(e4, t4, l4) {
  var u5 = i3(l4), c4 = (0, import_react6.useState)(function() {
    return e4.toHsva(t4);
  }), s5 = c4[0], f4 = c4[1], v4 = (0, import_react6.useRef)({ color: t4, hsva: s5 });
  (0, import_react6.useEffect)(function() {
    ...
    var r4;
    F3(s5, v4.current.hsva) || e4.equal(r4 = e4.fromHsva(s5), v4.current.color) || (v4.current = { hsva: s5, color: r4 }, u5(r4));
  }, [s5, e4, u5]);
...
var U2 = function(t4) {
  var n4 = t4.className, o4 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = t4.onChange, s5 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react6.useRef)(null);
  Q(f4);
  var v4 = Y2(o4, l4, i4), d4 = v4[0], h4 = v4[1], m5 = g3(["react-colorful", n4]);
  return import_react6.default.createElement("div", u3({}, s5, { ref: f4, className: m5 }), import_react6.default.createElement(T2, { hsva: d4, onChange: h4 }), import_react6.default.createElement(S4, { hue: d4.h, onChange: h4, className: "react-colorful__last-control" }));
};
var ee = function(r4) {
  var t4 = r4.className, n4 = r4.hsva, o4 = r4.onChange, a4 = { backgroundImage: "linear-gradient(90deg, " + k3(Object.assign({}, n4, { a: 0 })) + ", " + k3(Object.assign({}, n4, { a: 1 })) + ")" }, l4 = g3(["react-colorful__alpha", t4]), u5 = b3(100 * n4.a);
  ...
  }, "aria-label": "Alpha", "aria-valuetext": u5 + "%", "aria-valuenow": u5, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react6.default.createElement(p3, { className: "react-colorful__alpha-pointer", left: n4.a, color: k3(n4) })));
};
var re = function(t4) {
  var n4 = t4.className, o4 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = t4.onChange, s5 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react6.useRef)(null);
  Q(f4);
  var v4 = Y2(o4, l4, i4), d4 = v4[0], h4 = v4[1], m5 = g3(["react-colorful", n4]);
  return import_react6.default.createElement("div", u3({}, s5, { ref: f4, className: m5 }), import_react6.default.createElement(T2, { hsva: d4, onChange: h4 }), import_react6.default.createElement(S4, { hue: d4.h, onChange: h4 }), import_react6.default.createElement(ee, { hsva: d4, onChange: h4, className: "react-colorful__last-control" }));
};
var xe = { defaultColor: { r: 0, g: 0, b: 0, a: 1 }, toHsva: L2, fromHsva: I3, equal: F3 };
var Ce = function(r4) {
...
function __read(o4, n4) {
  ...
  try {
    ...
    try {
      if (r4 && !r4.done && (m5 = i4["return"])) m5.call(i4);
    } finally {
...
function ColorComponent() {
  ...
  return import_react9.default.createElement(Row, {
    input: true
  }, import_react9.default.createElement(Label, null, label), import_react9.default.createElement(PickerContainer, null, import_react9.default.createElement(Color2, {
    value,
    displayValue,
    onChange,
    onUpdate,
...
function Joystick({
  ...
  }, [w4, h4, onUpdate, set, stepV1, stepV2, v1, v22, yFactor]);
...
var schema2 = (o4, s5) => v8n_esm_default().array().length(2).every.number().test(o4) && v8n_esm_default().schema({
  min: number2,
  max: number2
}).test(s5);
var format2 = (v4) => ({
...
// node_modules/lamina/lamina.es.js
function N4(e4) {
  const t4 = de[e4.constructor], l4 = new t4();
  let r4 = "";
  return Object.entries(e4.properties).forEach(([n4, a4]) => {
    const i4 = t4["u_" + n4] ?? l4[n4];
    switch (n4) {
      case "name":
        a4 !== e4.constructor && (r4 += ` ${n4}={${JSON.stringify(a4)}}`);
        break;
      case "visible":
        a4 || (r4 += ` ${n4}={${JSON.stringify(a4)}}`);
        break;
      default:
        a4 !== i4 && (r4 += ` ${n4}={${JSON.stringify(a4)}}`);
        break;
    }
  }), r4;
}
...
function J3(e4) {
  const t4 = de[e4.constructor], l4 = new t4();
  let r4 = "	";
  return Object.entries(e4.properties).forEach(([a4, i4], d4) => {
    var L3;
    const g4 = `
		`;
    if (a4.includes("color")) {
      const $5 = typeof i4 == "string" ? i4 : "#" + i4.getHexString();
      r4 += `${a4}: ${JSON.stringify($5)},${g4}`;
    } else {
      const $5 = (L3 = t4["u_" + a4]) != null ? L3 : l4[a4];
      switch (a4) {
        case "name":
          i4 !== e4.constructor && (r4 += `${a4}: ${JSON.stringify(i4)},${g4}`);
          break;
        case "visible":
          i4 || (r4 += `${a4}:${JSON.stringify(i4)},${g4}`);
          break;
        default:
          i4 !== $5 && (r4 += `${a4}: ${JSON.stringify(i4)},${g4}`);
          break;
      }
    }
  }), r4;
...
function ae2(e4, t4) {
  const l4 = J3(t4), r4 = `${e4.map((a4) => `new ${a4.constructor}({
      ${J3(a4)}
      })`).join(`,
		`)}`;
  return `
...
function ne2({
  ...
  return useControls(
    ...
    () => {
      const n4 = {};
      return t4.forEach((a4, i4) => {
        const d4 = `${a4.label} ~${i4}`;
        n4[d4] = a4, n4[d4].onChange = () => r4([`${e4}.${d4}`, a4.label]);
      }), n4;
    },
    { store: l4 },
    [t4, e4]
...
var de2 = import_react12.default.forwardRef(({ children: e4, ...t4 }, l4) => {
  var j4, v4, M4;
  const r4 = import_react12.default.useRef(null);
  (0, import_react12.useImperativeHandle)(l4, () => r4.current);
  const n4 = useCreateStore(), [a4, i4] = import_react12.default.useState({}), [d4, L3] = import_react12.default.useState(["", ""]), g4 = (0, import_react12.useMemo)(() => new TextureLoader(), []);
  useControls(
    {
      "Copy JSX": button(() => {
        const c4 = r4.current.layers.map((f4) => f4.serialize()), o4 = re2(c4, r4.current.serialize());
        navigator.clipboard.writeText(o4);
      }),
      "Copy JS": button(() => {
        const c4 = r4.current.layers.map((f4) => f4.serialize()), o4 = ae2(c4, r4.current.serialize());
        navigator.clipboard.writeText(o4);
      })
    },
    { store: n4 }
  );
  const { Lighting: $5 } = useControls(
    "Base",
    {
      Color: {
        value: "#" + new Color(((j4 = r4.current) == null ? void 0 : j4.color) || (t4 == null ? void 0 : t4.color) || "white").convertLinearToSRGB().getHexString(),
        onChange: (c4) => {
          r4.current.color = c4;
        }
      },
      Alpha: {
        value: ((v4 = r4.current) == null ? void 0 : v4.alpha) || (t4 == null ? void 0 : t4.alpha) || 1,
        min: 0,
        max: 1,
        onChange: (c4) => {
          r4.current.alpha = c4;
      ...
      Lighting: {
        value: ((M4 = r4.current) == null ? void 0 : M4.lighting) || (t4 == null ? void 0 : t4.lighting) || "basic",
        options: Object.keys(ae)
      }
    },
    { store: n4 }
  ), [R3, z2] = (0, import_react12.useMemo)(() => ve({ ...t4, lighting: $5 }), [t4, $5]);
  return import_react12.default.useEffect(() => {
    const c4 = r4.current.layers, o4 = {};
    c4.forEach((f4, _2) => {
      f4.getSchema && (o4[`${f4.name} ~${_2}`] = f4.getSchema());
    }), i4(o4);
  }, [e4]), import_react12.default.useEffect(() => {
    const o4 = n4.getData()[d4[0]];
    if (o4) {
      const f4 = d4[0].split("."), _2 = parseInt(f4[0].split(" ~")[1]), h4 = d4[1], F4 = r4.current.layers[_2].uuid, b4 = r4.current.uniforms[`u_${F4}_${h4}`], y4 = r4.current.layers[_2];
      h4 !== "map" ? (y4[h4] = o4.value, b4 ? b4.value = q(o4.value) : (y4.buildShaders(y4.constructor), r4.current.refresh())) : (async () => {
        try {
          if (o4.value) {
            const S5 = await g4.loadAsync(o4.value);
            y4[h4] = S5, b4.value = S5;
          } else
            y4[h4] = void 0, b4.value = void 0;
        } catch (S5) {
          console.error(S5);
        }
      })();
    }
  }, [d4]), import_react12.default.useLayoutEffect(() => {
    var c4;
    r4.current.layers = (c4 = r4.current.__r3f.children) == null ? void 0 : c4.map((o4) => o4.object), r4.current.refresh();
  }, [e4, R3]), import_react12.default.useLayoutEffect(() => {
    const c4 = document.body.querySelector("#root"), o4 = document.createElement("div");
    return c4 && (c4.appendChild(o4), (0, import_client2.createRoot)(o4).render(
      (0, import_jsx_runtime21.jsx)(
        LevaPanel,
        {
          titleBar: {
            title: t4.name || r4.current.name
          },
          store: n4
        }
      )
  ...
  }, [t4.name]), (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [
    Object.entries(a4).map(([c4, o4], f4) => (0, import_jsx_runtime21.jsx)(ne2, { name: c4, layers: o4, store: n4, setUpdate: L3 }, `${c4} ~${f4}`)),
    (0, import_jsx_runtime21.jsx)("layerMaterial", { args: [R3], ref: r4, ...z2, children: e4 })
  ] });
});
extend({
  LayerMaterial: ne,
...
var me = import_react12.default.forwardRef(({ children: e4, ...t4 }, l4) => {
  const r4 = import_react12.default.useRef(null);
  (0, import_react12.useImperativeHandle)(l4, () => r4.current), import_react12.default.useLayoutEffect(() => {
    var i4;
    r4.current.layers = (i4 = r4.current.__r3f.children) == null ? void 0 : i4.map((d4) => d4.object), r4.current.refresh();
  }, [e4]);
  const [n4, a4] = (0, import_react12.useMemo)(() => ve(t4), [t4]);
  return (0, import_jsx_runtime21.jsx)("layerMaterial", { args: [n4], ref: r4, ...a4, children: e4 });
});
function m4(e4) {
  return [
    {
      mode: e4 == null ? void 0 : e4.mode,
      visible: e4 == null ? void 0 : e4.visible,
      type: e4 == null ? void 0 : e4.type,
      mapping: e4 == null ? void 0 : e4.mapping,
      map: e4 == null ? void 0 : e4.map,
      axes: e4 == null ? void 0 : e4.axes
    }
  ];
}
var ge = import_react12.default.forwardRef((e4, t4) => (0, import_jsx_runtime21.jsx)("depth_", { args: m4(e4), ref: t4, ...e4 }));
var $e = import_react12.default.forwardRef((e4, t4) => (0, import_jsx_runtime21.jsx)("color_", { ref: t4, args: m4(e4), ...e4 }));
var he = import_react12.default.forwardRef((e4, t4) => (0, import_jsx_runtime21.jsx)("noise_", { ref: t4, args: m4(e4), ...e4 }));
var ye = import_react12.default.forwardRef((e4, t4) => (0, import_jsx_runtime21.jsx)("fresnel_", { ref: t4, args: m4(e4), ...e4 }));
var Le = import_react12.default.forwardRef((e4, t4) => (0, import_jsx_runtime21.jsx)("gradient_", { ref: t4, args: m4(e4), ...e4 }));
var _e = import_react12.default.forwardRef((e4, t4) => (0, import_jsx_runtime21.jsx)("matcap_", { ref: t4, args: m4(e4), ...e4 }));
var be = import_react12.default.forwardRef((e4, t4) => (0, import_jsx_runtime21.jsx)("texture_", { ref: t4, args: m4(e4), ...e4 }));
var Se = import_react12.default.forwardRef((e4, t4) => (0, import_jsx_runtime21.jsx)("displace_", { ref: t4, args: m4(e4), ...e4 }));
var we = import_react12.default.forwardRef((e4, t4) => (0, import_jsx_runtime21.jsx)("normal_", { ref: t4, args: m4(e4), ...e4 }));
export {
  $e as Color,
